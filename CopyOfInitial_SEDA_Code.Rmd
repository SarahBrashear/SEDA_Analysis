...
pe_all %>%
  ggplot(aes(x = `1`,
    ...
    labs(title = "Posterior for Student Achievement in Districts with Average SES",
         subtitle = "",
         x = "Expected Student Achievement",
         y = "Probability") +
...
low_ses_plot <- plot_data_1 %>% 
  pivot_longer(cols = `Texas_Low`:`Massachusetts_Low`,
               names_to = "state",
...
mean_ses_plot <- plot_data_2 %>% 
  pivot_longer(cols = `Texas_Mean`:`Massachusetts_Mean`,
               names_to = "state",
               values_to = "achievement") %>%
  ggplot(aes(x = achievement, 
             fill = state,
...
high_ses_plot <- plot_data_3 %>% 
  pivot_longer(cols = `Texas_High`:`Massachusetts_High`,
               names_to = "state",
               values_to = "achievement") %>%
  ggplot(aes(x = achievement, 
             fill = state,
